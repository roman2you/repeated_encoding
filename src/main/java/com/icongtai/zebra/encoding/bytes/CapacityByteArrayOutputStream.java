...
public class CapacityByteArrayOutputStream extends OutputStream {
  ...
  public long getCurrentIndex() {
    Preconditions.checkArgument(bytesUsed > 0, "This is an empty stream");
    return bytesUsed - 1;
  }
  ...
  public void setByte(long index, byte value) {
    Preconditions.checkArgument(index < bytesUsed, "Index: " + index + " is >= the current size of: " + bytesUsed);
