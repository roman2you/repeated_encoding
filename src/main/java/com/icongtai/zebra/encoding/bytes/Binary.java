...
abstract public class Binary implements Comparable<Binary>, Serializable {
  ...
  private static class FromStringBinary extends ByteBufferBackedBinary {
    ...
    private static ByteBuffer encodeUTF8(String value) {
      try {
        ...
        throw new ZebraEncodingException("UTF-8 not supported.", e);
      }
    }
  }
  ...
  private static class ByteArrayBackedBinary extends Binary {
    ...
    @Override
    public String toStringUsingUTF8() {
      return BytesUtils.UTF8.decode(ByteBuffer.wrap(value)).toString();
    }
    ...
    public String toStringUsingUTF8() {
      ...
      if (value.hasArray()) {
        try {
          ...
          throw new ZebraDecodingException("UTF-8 not supported");
        }
      } else {
        ...
        ret = BytesUtils.UTF8.decode(value).toString();
        value.limit(limit);
