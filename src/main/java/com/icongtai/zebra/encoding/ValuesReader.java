 ...
 * under the License.
 */
package com.icongtai.zebra.encoding;
...
public abstract class ValuesReader {
   ...
   * @throws IOException
   */
  public abstract void init(int valueCount, byte[] buf, int offset) throws IOException;
  ...
  public int getNextOffset() {
    throw new ZebraDecodingException("Unsupported: cannot get offset of the next section.");
  }
