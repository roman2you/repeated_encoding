...
public class PlainValuesWriter extends ValuesWriter {
  ...
  public final void writeFloat(float v) {
    try {
      ...
      throw new ZebraEncodingException("could not write float", e);
    }
  }
  ...
  public final void writeDouble(double v) {
    try {
      ...
      throw new ZebraEncodingException("could not write double", e);
    }
  }
  ...
  public void writeByte(int value) {
    try {
      ...
      throw new ZebraEncodingException("could not write byte", e);
    }
  }
