  ...
  public static class DoublePlainValuesReader extends PlainValuesReader {
    ...
    public void skip() {
      try {
        ...
        throw new ZebraDecodingException("could not skip double", e);
      }
    }
    ...
    public double readDouble() {
      try {
        ...
        throw new ZebraDecodingException("could not read double", e);
      }
    }
  }
  ...
  public static class FloatPlainValuesReader extends PlainValuesReader {
    ...
    public void skip() {
      try {
        ...
        throw new ZebraDecodingException("could not skip float", e);
      }
    }
    ...
    public float readFloat() {
      try {
        ...
        throw new ZebraDecodingException("could not read float", e);
      }
    }
  }
  ...
  public static class IntegerPlainValuesReader extends PlainValuesReader {
    ...
    public void skip() {
      try {
        ...
        throw new ZebraDecodingException("could not skip int", e);
      }
    }
  ...
  public static class LongPlainValuesReader extends PlainValuesReader {
    ...
    public void skip() {
      try {
        ...
        throw new ZebraDecodingException("could not skip long", e);
      }
    }
    ...
    public long readLong() {
      try {
        ...
        throw new ZebraDecodingException("could not read long", e);
      }
    }
  }
}