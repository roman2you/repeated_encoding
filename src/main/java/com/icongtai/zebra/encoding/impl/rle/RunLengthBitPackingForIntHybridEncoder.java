...
class RunLengthBitPackingForIntHybridEncoder extends RunLengthBitPackingHybridEncoder {

    public static final Log LOG = Log.getLog(RunLengthBitPackingForIntHybridEncoder.class);
    ...
    public RunLengthBitPackingForIntHybridEncoder(int bitWidth, boolean signed, int initialCapacity) {
        LOG.debug(String.format("Encoding: RunLengthBitPackingForIntHybridEncoder with "
    ...
    public void writeInt(int value) throws IOException {
        if (signed) {
            value = BytesUtils.zigzagInt(value);
        }
